...
class MofgForm
{
    ...
    public const FMT_NONE = 0;
    public const FMT_INT = 1;
    public const FMT_ALP = 2;
    public const FMT_NUM = 3;
    public const FMT_ALPNUM = 4;
    public const FMT_HIRA = 5;
    public const FMT_KATA = 6;
    public const FMT_TEL = 7;
    public const FMT_EMAIL = 8;
    public const FMT_URL = 9;

    public const FLT_TO_ZENKAKU_KANA = 1;
    public const FLT_TO_HANKAKU_ALPNUM = 2;
    public const FLT_TO_UPPER_CASE = 3;
    public const FLT_TO_LOWER_CASE = 4;
    public const FLT_EOL_TO_N = 5;
    public const FLT_EOL_TO_SPACE = 6;
    public const FLT_TRIM = 7;
    public const FLT_RTRIM = 8;
    public const FLT_LTRIM = 9;

    public const E_DEFAULT = "_-1";
    public const E_NONE = "_0";
    public const E_REQUIRED = "_1";
    public const E_MINLEN = "_2";
    public const E_MAXLEN = "_3";
    public const E_PATTERN = "_4";
    public const E_FMT_INT = "_5";
    public const E_FMT_ALP = "_6";
    public const E_FMT_NUM = "_7";
    public const E_FMT_ALPNUM = "_8";
    public const E_FMT_HIRA = "_9";
    public const E_FMT_KATA = "_10";
    public const E_FMT_TEL = "_11";
    public const E_FMT_EMAIL = "_12";
    public const E_FMT_URL = "_13";

    public const CTL_ENTER = "enter";
    public const CTL_BACK = "back";
    public const CTL_RESET = "reset";
